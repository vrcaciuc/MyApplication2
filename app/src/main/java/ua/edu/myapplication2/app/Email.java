...
/**
 * Created by vcaciuc on 5/23/2014.
 */
...
public class Email extends Activity implements View.OnClickListener{
    ...
    public void onClick(View v){
        ...
        String message = "Well hello" + "name" + "I just wanted to say" +
                ...
                stupidAction + ", that just really makes me crazy. I just want to make you " +
                hatefulAct + ". Well, that's all I wanted to chit-chatter about, oh and " +
                out + ". Oh also if you get bored you should check out www.mybringback.com" +
